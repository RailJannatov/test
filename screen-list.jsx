// Variation A — Classic vertical list. CeleBreak-style: section headers
// (Today / Tomorrow), prominent game cards with avatar stack + slot bar.

function ListGameCard({ g }) {
